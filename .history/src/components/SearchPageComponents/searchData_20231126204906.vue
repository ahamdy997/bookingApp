      ...
      >
        <div class="flex h-full">
                ...
                <div class="star-rating flex">
                  <div v-for="n in 5" :key="n">
                      ...
                      v-if="
                        ...
                        Number(
                          data.hotels.property.reviewScore % 2 == 0
                            ? Math.round(
                                +data.hotels.property.reviewScore * 10
                              ) /
                                2 /
                                10
                            : Math.round(
                                (+data.hotels.property.reviewScore * 10 + 1) /
                                  10
                              ) / 2
                        )
                      "
                    ...
                    <span
                      v-else-if="
                        (n - 0.5 ===
                          Number(data.hotels.property.reviewScore % 2)) ==
                        0
          ...
          <div class="ms-auto text-end">
            <p
              v-if="
                data.hotels.property.priceBreakdown?.excludedPrice?.value !=
                undefined
              "
              ...
              {{
                Math.round(
                  ((Number(
                    ...
                    100) /
                    Number(
                      data.hotels.property.priceBreakdown.grossPrice.value
                    )) *
                    100
                ) / 100
              }}% off
            ...
            >
              <p class="text-sm text-[#EB5757] line-through">
                $
                {{
                  data.hotels.property.priceBreakdown.grossPrice.value.toFixed(
                    2
                  )
                }}
              </p>
              ...
              >
                $
                {{
                  data.hotels.property.priceBreakdown.excludedPrice.value.toFixed(
                    2
                  )
                }}
              </p>
