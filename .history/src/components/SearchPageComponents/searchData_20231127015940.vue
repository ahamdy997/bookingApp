<template>
  ...
  <nav class="absolute left-[61%] top-[318%] flex gap-3">
    <button @click="prevPage" :disabled="dataStore.currentPage === 1">
      Previous
    </button>
    <span>{{ dataStore.currentPage }}</span>
    <button
      @click="nextPage"
      :disabled="dataStore.currentPage === dataStore.totalPages"
    >
      Next
    </button>
  </nav>
