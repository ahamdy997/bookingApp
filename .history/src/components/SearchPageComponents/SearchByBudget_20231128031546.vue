      ...
      <div class="flex justify-between items-center mt-4">
        <div class="flex items-center gap-2">
          <input
            type="checkbox"
            v-model="modelfor0"
            @change="getAPIFilteredData(0, 200)"
            class="ml-4"
            id="0-200"
          />
      ...
      <div class="flex justify-between items-center mt-4">
        <div class="flex items-center gap-2">
          <input
            type="checkbox"
            v-model="modelfor200"
            @change="getAPIFilteredData(200, 500)"
            class="ml-4"
            id="200-500"
          />
      ...
      <div class="flex justify-between items-center mt-4">
        <div class="flex items-center gap-2">
          <input
            type="checkbox"
            v-model="modelfor500"
            @change="getAPIFilteredData(500, 1000)"
            class="ml-4"
            id="500-1000"
          />
      ...
      <div class="flex justify-between items-center mt-4">
        <div class="flex items-center gap-2">
          <input
            ...
            @click="getAPIFilteredData(1000, 2000)"
            class="ml-4"
            id="1000-2000"
          />
      ...
      <div class="flex justify-between items-center mt-4">
        <div class="flex items-center gap-2">
          <input
            ...
            @change="console.log(modelfor2000)"
            class="ml-4"
            :id="label"
          />
...
const getAPIFilteredData = async (min, max) => {
  ...
  const options = {
    ...
    params: {
      dest_id: `${keepDataAliveStore.mapbox.filter((el) => el.searc)}`,
      search_type: "city",
