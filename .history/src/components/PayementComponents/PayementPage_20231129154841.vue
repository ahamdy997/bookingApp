              ...
              <div class="flex justify-around">
                <div class="mb-5">
                  ...
                  <input
                    type="text"
                    id="firstName"
                    class="border outline-none border-color-secondary focus:border focus:border-[var(--mainBlue)] text-gray-900 text-sm rounded-lg focus:bg-white block w-full p-2.5 dark:placeholder-gray-400"
