              ...
              <div class="mb-5 w-1/2 ml-4 mt-7">
                ...
                <div class="flex">
                  <input
                    type="text"
                    id="firstName"
                    class="bg-color-secondary outline-none border border-color-secondary focus:border focus:border-blue text-gray-900 text-sm rounded-lg focus:bg-white block w-full p-2.5 dark:placeholder-gray-400"
