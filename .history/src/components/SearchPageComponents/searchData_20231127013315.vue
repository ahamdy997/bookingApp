<template>
  ...
  >
    ...
    <ul>
      <li
        v-for="data in dataStore.paginatedItemsX"
...
const totalPages = computed(() =>
  Math.ceil(dataStore.paginatedItems.length / dataStore.paginatedItemsPerPage)
);

const paginatedItemsX = watch(dataStore.paginatedItems, () => {
