              ...
              <div class="flex justify-between">
                ...
                <div class="bg-[#efefef ] mb-5 w-8/12">
                  <input
                    type="number"
                    id="phone"
                    class="border-secondary outline-none focus:border focus:border-[var(--mainBlue)] text-gray-900 text-sm rounded-lg focus:bg-white w-full p-2.5 dark:placeholder-gray-400"
