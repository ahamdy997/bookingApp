    ...
    <div class="content mt-5 rounded-md overflow-hidden">
      ...
      <div class="flex justify-between items-center mt-4">
        <div class="flex items-center gap-2">
          <input
            type="checkbox"
            @change="console.log(model1)"
            v-model="model1"
            class="ml-4"
          />
          <label for="data.label" class="text-sm">$ 0 - $ 200</label>
        </div>
      ...
      <div class="flex justify-between items-center mt-4">
        <div class="flex items-center gap-2">
          <input
            ...
            class="ml-4"
          />
          <label :for="label" class="text-sm">$ 200 - $ 500</label>
        </div>
        <h2 class="mr-4 text-sm">100</h2>
      </div>
      ...
      <div class="flex justify-between items-center mt-4">
        <div class="flex items-center gap-2">
          <input
            ...
            class="ml-4"
          />
          <label :for="label" class="text-sm"> $ 500 - $ 1,000</label>
        </div>
        <h2 class="mr-4 text-sm">data.number</h2>
      </div>
      ...
      <div class="flex justify-between items-center mt-4">
        <div class="flex items-center gap-2">
          <input
            ...
            :id="label"
          />
          <label :for="label" class="text-sm">$ 1,000 - $ 2,000 </label>
        </div>
        <h2 class="mr-4 text-sm">number</h2>
      </div>
