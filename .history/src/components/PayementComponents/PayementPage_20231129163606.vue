                ...
                <div class="mb-5 ml-3">
                  ...
                  <div class="flex">
                    <input
                      type="number"
                      id="lastName"
                      class="bg-color-secondary outline-none border border-color-secondary focus:border focus:border-blue text-gray-900 text-sm rounded-lg focus:bg-white w-full p-2.5 dark:placeholder-gray-400"
                      placeholder="203846"
                      required
                    />
                    <img
