<template>
  ...
  <nav class="w-full justify-center m-auto flex gap-3">
    ...
    <span class="bg-[var(--mainBlue)] px-2 rounded-xl">1</span>
    <span class="bg-[var(--mainBlue)] px-2 rounded-xl">2</span>
    <span class="bg-[var(--mainBlue)] px-2 rounded-xl">3</span>
    <span class="bg-[var(--mainBlue)] px-2 rounded-xl">4</span>
    <span class="bg-[var(--mainBlue)] px-2 rounded-xl">5</span>
    <button
