<template>
  ...
  <nav class="w-full justify-center m-auto flex gap-3">
    ...
    <span
      class="px-2 cursor-pointer rounded-xl"
      :class="{ bg: bgColor }"
      @click="paginationClickHandling(1)"
    >
      1
    </span>
    <span
      class="px-2 cursor-pointer rounded-xl"
      :class="{ bg: bgColor }"
      @click="paginationClickHandling(2)"
    >
      2
    </span>
    <span
      class="px-2 cursor-pointer rounded-xl"
      :class="{ bg: bgColor }"
      @click="paginationClickHandling(3)"
    >
      3
    </span>
    <span
      class="px-2 cursor-pointer rounded-xl"
      :class="{ bg: bgColor }"
      @click="paginationClickHandling(4)"
    >
      4
    </span>
    <span
      class="px-2 cursor-pointer rounded-xl"
      :class="{ bg: bgColor }"
      @click="paginationClickHandling(5)"
    >
      5
    </span>
