<template>
  <header class="flex items-center h-17">
    <nav class="flex items-center justify-between w-86 m-auto">
      <div class="flex items-center gap-1">
        ...
        <p class="logo-name">my Dream Place</p>
      </div>
      ...
      <div class="register">
        <button type="button" class="rounded-md border-solid border">
          Register
        </button>
      </div>
    </nav>
...
<style scoped>
button {
  border-color: rgb(49, 130, 237)4%, 56%);
  background: #2f80ed;
  cursor: pointer;
