...
import TheHoteldetailsVue from "@/views/layouts/HotelDetails/TheHoteldetails.vue";
...
const routes = [
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "sign-in" */ "@/components/HomeComponents/HeaderComponent/LocationInput/LocationInput.vue"
      ),
  },
  {
    path: "/details",
    ...
    // component: () =>
    //   import(
    //     /* webpackChunkName: "hotelDetails" */ "@/views/layouts/HotelDetails/TheHoteldetails.vue"
    //   ),
    component: TheHoteldetailsVue,
  },
  {
    path: "/:notfound(.*)",
    name: "notFound",
