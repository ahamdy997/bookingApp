<template>
  ...
  <nav class="w-full justify-center m-auto flex gap-3">
    ...
    <span class="px-2 cursor-pointer rounded-xl">1</span>
    <span class="px-2 cursor-pointer rounded-xl">2</span>
    <span class="px-2 cursor-pointer rounded-xl">3</span>
    <span class="px-2 cursor-pointer rounded-xl">4</span>
    <span class="px-2 cursor-pointer rounded-xl">5</span>
    <button
