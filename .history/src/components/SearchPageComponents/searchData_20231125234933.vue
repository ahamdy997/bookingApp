<template>
  <div v-show="dataStore" class="search-result w-[915px] me-auto">
      ...
      >
        <div class="flex mt-5 h-full mx-5">
          ...
          <div class="content mr-6">
            <h2 class="font-semibold text-xl max-w[60%]">
              {{ data.property.name }}
            </h2>
            <div class="description">
              <div class="rating mb-[17px] mt-2.5 flex items-center">
                <stars-number
                  :starsNumber="
          ...
          <div class="ms-auto text-end">
            ...
            >
              {{
                Number(data.property.priceBreakdown.grossPrice.value * 100) /
                Number(data.property.priceBreakdown.excludedPrice.value * 100)
              }}% off
            </p>
            <div
