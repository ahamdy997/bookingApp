...
const logIn = function () {
  ...
  const saveUser = {
    token: btoa(JSON.stringify(logIn)),
    date: userExpDate(),
  };
  if (
    ...
    console.log(
      JSON.parse(
        atob(
          "eyJlbWFpbCI6ImFobWVkaGFtZHlAZ21haWwuY29tIiwicGFzc3dvcmQiOiJhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYSIsImRhdGUiOiIyMDIzMTIzMTYzMiJ9"
        )
      )
    );
  } else {
