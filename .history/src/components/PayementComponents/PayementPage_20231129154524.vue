              ...
              <div class="flex justify-around">
                <div class="mb-5">
                  ...
                  <input
                    type="text"
                    id="firstName"
                    class="bg-color-secondary border outline-none border-color-secondary focus:border focus:border-blue text-gray-900 text-sm rounded-lg focus:bg-white block w-full p-2.5 dark:placeholder-gray-400"
