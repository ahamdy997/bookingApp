<template>
  ...
  <nav class="w-full justify-center m-auto flex gap-3">
    ...
    <span
      ...
      @click="useAPIDataStore.currentPage = 1"
      >1</span
    >
    <span
      class="px-2 cursor-pointer rounded-xl"
      @click="useAPIDataStore.currentPage = 2"
      >2</span
    >
    <span
      class="px-2 cursor-pointer rounded-xl"
      @click="useAPIDataStore.currentPage = 3"
      >3</span
    >
    <span
      class="px-2 cursor-pointer rounded-xl"
      @click="useAPIDataStore.currentPage = 4"
      >4</span
    >
    <span
      class="px-2 cursor-pointer rounded-xl"
      @click="useAPIDataStore.currentPage = 5"
      :class="{ [bg-[var(--mainBlue)]:(useAPIDataStore.currentPage=5)]: show }"
      >5</span
    >
    <button
