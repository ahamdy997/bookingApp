  ...
  >
    <div class="flex w-full justify-between relative items-center">
      ...
      <div
        ...
        class="text-start flex items-center justify-end w-[25%] border rounded-md h-[48px] cursor-pointer"
        @click="ShowSortBy"
      >
        <div class="w-[190px]"><span class="text-[#828282]">Sort By</span></div>
        <img
      ...
      <ul
        class="text-black absolute w-[220px] right-0 flex flex-col gap-3 rounded-lg shadow-md pt-2 px-1 top-[50px] bg-[#f2f2f2]"
        v-show="show"
      >
