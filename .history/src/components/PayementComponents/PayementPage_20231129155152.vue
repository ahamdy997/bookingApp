              ...
              <div class="flex justify-around">
                <div class="mb-5">
                  ...
                  <input
                    type="text"
                    id="firstName"
                    class="bg-color-secondary border outline-none border-color-secondary focus:border focus:border-[var(--mainBlue)] text-gray-900 text-sm rounded-lg focus:bg-white mr-4 block w-full p-2.5 dark:placeholder-gray-400"
                ...
                <div class="mb-5">
                  ...
                  <input
                    type="text"
                    id="lastName"
                    class="bg-color-secondary border outline-none border-color-secondary focus:border focus:border-blue text-gray-900 text-sm rounded-lg focus:bg-white w-full p-2.5 dark:placeholder-gray-400"
