<template>
  <div
    ...
    class="search-result w-[915px] me-auto mb-[60px]"
  >
            ...
            <div class="rating flex items-center">
              <div class="star-rating flex">
                <div v-for="n in 5" :key="n">
                  <span
                    v-if="n <= stars(data.property.reviewScore)"
                    class="filled"
                    >&#9733;</span
                  >
                  <span
  ...
  <nav class="absolute left-[61%] top-[118%] flex gap-3">
...
const startIndex = ref((currentPage - 1) * itemsPerPage);
const endIndex = ref(startIndex + itemsPerPage);
const totalPages = computed(() =>
  Math.ceil(dataStore.hotelSearchData.length / dataStore.hotelSearchDataPerPage)
);
const paginatedItems = ref(watch()={

  returndataStore.hotelSearchData.slice(startIndex, endIndex)
}
);
// onUpdated(() => {
...
//     return dataStore.hotelSearchData.slice(startIndex, endIndex);
//   };
// });
const nextPage = () => {
