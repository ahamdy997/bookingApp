        ...
        <div class="flex h-full">
          ...
          <div class="content">
            ...
            <div class="description">
              <div class="rating flex items-center">
                <stars-number
                  v-show="data.property.reviewScore"
                  :starsNumber="
                ...
                <p
                  v-show="data.property.reviewScore"
                  class="text-sm text-[#4f4f4f] ml-[12px]"
                >
                  {{
                    +data.property.reviewScore % 2 == 0
                      ? Math.round(+data.property.reviewScore * 10) / 2 / 10
          ...
          <div class="ms-auto text-end">
            <p
              ...
              v-if="data.property.priceBreakdown.excludedPrice"
            >
              Book now and receive
              {{
                Math.round(
                  ((Number(data.property.priceBreakdown.excludedPrice) * 100) /
                    Number(data.property.priceBreakdown.grossPrice)) *
                    100
                ) / 100
              }}% off
            </p>
            ...
            >
              {{
                Math.round(
                  (Number(hotel.property.priceBreakdown.excludedPrice.value) *
                    100000) /
