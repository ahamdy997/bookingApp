<template>
  <BaseBaseSpinnerVue v-if="dataStore.isLoading"></BaseBaseSpinnerVue>

  <div v-else class="search-result w-[915px] me-auto mb-[60px] mt-[50px]">
    <div class="flex w-full justify-between relative items-center">
      ...
      >
        <div class="w-[190px]">
          <label class="text-[#828282]" for="sort-by" @click="ShowSortBy"
            >Sort By</label
          ><input
            type="text"
            ...
            <div class="flex items-center h-full">
                ...
                <button
                  ...
                  @click="
                    getHotelDescription(
                      ...
                      data.property.priceBreakdown?.grossPrice?.value,
              ...
              <div class="ms-auto text-end">
                ...
                <p
                  ...
                  v-if="data.property.priceBreakdown?.strikethroughPrice?.value"
                >
                  {{
                    Math.round(
                      (((Number(
                ...
                >
                  <p
                    class="text-sm text-[#EB5757] line-through"
                    v-if="
                      data.property.priceBreakdown?.strikethroughPrice?.value
                    "
                  >
                    $
                    {{
                      data.property.priceBreakdown.strikethroughPrice.value.toFixed(
                        2
                      )
                    }}
                  </p>
  ...
  <!-- <div class="search-result w-[915px] me-auto mt-[50px]" v-else>
    <p class="text-[20px] text-red-700 font-semibold">
      Fetching Data For you Please Wait.... Or Press search Button if You Didn't
      press it.
    </p>
  </div> -->
</template>
...
import BaseSpinnerVue from "../BaseSpinner/BaseSpinner.vue";
...
/////////// Call Api To get hotel Details and Store important data for my trip
const getHotelDescription = function (
  ...
  dataStore.strikethroughPrice = strikethroughPrice;
  dataStore.grossPrice = grossPrice;
  dataStore.myTripImgSrc = imgSrc;
};

//////////////////////Call Api For Sort By/////////////////////////////
