              ...
              <div class="flex justify-between">
                <div class="drop w-3/12">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <button
                        @click="show = !show"
                        class="flex items-center p-2 text-gray-900 bg-color-secondary focus:border-[var(--mainBlue)] rounded-md w-24"
                      >
                ...
                <div class="mb-5 w-8/12">
                  <input
                    type="number"
                    id="phone"
                    class="bg-color-secondary outline-none focus:border focus:border-blue text-gray-900 text-sm rounded-lg focus:bg-white w-full p-2.5 dark:placeholder-gray-400"
