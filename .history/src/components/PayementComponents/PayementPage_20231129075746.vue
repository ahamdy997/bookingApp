              ...
              <div class="flex justify-between">
                ...
                <div class="mb-5 w-8/12">
                  <input
                    type="number"
                    id="phone"
                    class="bg-color-secondary outline-none border-[var(--mainBlue)] focus:border focus:border-blue text-gray-900 text-sm rounded-lg focus:bg-white w-full p-2.5 dark:placeholder-gray-400"
