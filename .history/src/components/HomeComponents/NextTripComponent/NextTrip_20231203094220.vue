...
.nature {
  background: linear-gradient(
    ...
    url("@/assets/next-trip-images/top-destiniation.jpg"), lightgray 50%;
...
.rest {
  background: linear-gradient(
    ...
    url("@/assets/next-trip-images/resturanat.jpg"), lightgray 50%;
  background-size: cover;
}
...
.sedny {
  background: linear-gradient(
    ...
    url("@/assets/home-images/f05ea716209b4ede5a3107407feb60d4.jpg"),
    lightgray 50%;
  background-size: cover;
}
h3,
